...
async def main():
    async with async_playwright() as p:
        ...
        for width in (1440, 390):
            ...
            await expect(page.locator('.atlas-tree-breadcrumbs')).to_contain_text('Marketing & Communications')
            ...
            await page.keyboard.press('Enter')
            await expect(page.locator('#record-title')).to_have_text('Marketing & Communications')
            await page.go_back()
            await expect(page.locator('#record-title')).to_have_text('Website')
